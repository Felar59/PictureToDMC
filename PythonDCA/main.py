...
_CLIENT_ROUTES = {
    ...
    "reports",
    "lab",
    # The old French paths are deliberately NOT here: `_LEGACY` below answers them
    # with a real 301 before a request ever reaches the static fallback, which is
    # the stronger answer. Adding them here would be dead weight that reads like a
    # second, contradictory opinion about what those URLs are.
}

(function(){"use strict";const F=new Float64Array(256);for(let e=0;e<256;e++){const r=e/255;F[e]=r<=.04045?r/12.92:((r+.055)/1.055)**2.4}const S=.95047,V=1.08883,w=.008856,P=7.787;function k(e){return e>w?Math.cbrt(e):P*e+16/116}function m(e,r,n){const a=F[e<0?0:e>255?255:e|0],t=F[r<0?0:r>255?255:r|0],B=F[n<0?0:n>255?255:n|0],u=k((a*.4124+t*.3576+B*.1805)/S),l=k(a*.2126+t*.7152+B*.0722),A=k((a*.0193+t*.1192+B*.9505)/V);return[116*l-16,500*(u-l),200*(l-A)]}function L(e,r){const n=e[0]-r[0],a=e[1]-r[1],t=e[2]-r[2];return n*n+a*a+t*t}function v(e){const r=parseInt(e.replace("#",""),16);return[r>>16&255,r>>8&255,r&255]}function b(e,r){if(r<=0)return;const n=1+r/100*.6;for(let a=0;a<e.length;a+=3)e[a+1]*=n,e[a+2]*=n}function T(e,r,n,a){const t=n*a;if(t===0)return;const B=D=>[e[D*3],e[D*3+1],e[D*3+2]],u=[],l=[],A=D=>{r[D]!==0&&(u.push(D),l.push(B(D)))};for(let D=0;D<n;D++)A(D),A((a-1)*n+D);for(let D=1;D<a-1;D++)A(D*n),A(D*n+n-1);if(u.length===0)return;const s=324,o=D=>{for(const E of l)if(L(D,E)<=s)return!0;return!1},i=new Uint8Array(t),C=new Int32Array(t);let c=0,g=0;for(const D of u)!i[D]&&o(B(D))&&(i[D]=1,C[g++]=D);for(;c<g;){const D=C[c++];r[D]=0;const E=D%n,h=(D-E)/n;E>0&&d(D-1),E<n-1&&d(D+1),h>0&&d(D-n),h<a-1&&d(D+n)}function d(D){i[D]||r[D]===0||o(B(D))&&(i[D]=1,C[g++]=D)}}function R(e,r){const n=new Float64Array(r*3);for(let a=0;a<r;a++){const t=m(e[a*4],e[a*4+1],e[a*4+2]);n[a*3]=t[0],n[a*3+1]=t[1],n[a*3+2]=t[2]}return n}const G=`Ecru|Ecru/off-white|FFF7E7
Blanc|White|FCFCFF
White|White|FCFCFF
...
`).map(e=>{const[r,n,a]=e.split("|"),t=v(a);return{num:r,name:n,hex:`#${a}`,rgb:t,lab:m(t[0],t[1],t[2])}}),p=new Map(G.map(e=>[e.num.toLowerCase(),e]));function q(e){return p.get(e.trim().toLowerCase())}function O(e,r=G){const n=e.length;if(n===0)return[];const a=r.length,t=n*a,B=new Float64Array(t);for(let o=0;o<n;o++){const i=e[o];for(let C=0;C<a;C++)B[o*a+C]=L(i,r[C].lab)}const u=new Int32Array(t);for(let o=0;o<t;o++)u[o]=o;u.sort((o,i)=>B[o]-B[i]);const l=new Array(n),A=new Uint8Array(a);let s=0;for(let o=0;o<t&&s<n;o++){const i=u[o],C=i/a|0,c=i-C*a;l[C]||A[c]||(l[C]=r[c],A[c]=1,s++)}for(let o=0;o<n;o++)if(!l[o]){let i=0,C=1/0;for(let c=0;c<r.length;c++){const g=L(e[o],r[c].lab);g<C&&(C=g,i=c)}l[o]=r[i]}return l}function U(e){let r=e>>>0;return()=>{r=r+1831565813>>>0;let n=r;return n=Math.imul(n^n>>>15,n|1),n^=n+Math.imul(n^n>>>7,n|61),((n^n>>>14)>>>0)/4294967296}}const W=60,I=42;function z(e,r){const n=e.length/3;if(n===0||r<=0)return{centroids:new Float64Array(0),labels:new Int32Array(0)};const a=N(e,n);r=Math.min(r,a);const t=U(I),B=Y(e,n,r,t),u=new Int32Array(n),l=new Float64Array(r*3),A=new Int32Array(r);for(let s=0;s<W;s++){let o=!1;for(let i=0;i<n;i++){const C=e[i*3],c=e[i*3+1],g=e[i*3+2];let d=0,D=1/0;for(let E=0;E<r;E++){const h=C-B[E*3],y=c-B[E*3+1],M=g-B[E*3+2],f=h*h+y*y+M*M;f<D&&(D=f,d=E)}u[i]!==d&&(u[i]=d,o=!0)}l.fill(0),A.fill(0);for(let i=0;i<n;i++){const C=u[i];l[C*3]+=e[i*3],l[C*3+1]+=e[i*3+1],l[C*3+2]+=e[i*3+2],A[C]++}for(let i=0;i<r;i++)A[i]!==0&&(B[i*3]=l[i*3]/A[i],B[i*3+1]=l[i*3+1]/A[i],B[i*3+2]=l[i*3+2]/A[i]);if(!o)break}return{centroids:B,labels:u}}function N(e,r){const n=new Set;for(let a=0;a<r;a++)if(n.add(`${e[a*3]|0},${e[a*3+1]|0},${e[a*3+2]|0}`),n.size>64)return n.size;return n.size}function Y(e,r,n,a){const t=new Float64Array(n*3),B=Math.floor(a()*r);t[0]=e[B*3],t[1]=e[B*3+1],t[2]=e[B*3+2];const u=new Float64Array(r).fill(1/0);for(let l=1;l<n;l++){let A=0;for(let i=0;i<r;i++){const C=e[i*3]-t[(l-1)*3],c=e[i*3+1]-t[(l-1)*3+1],g=e[i*3+2]-t[(l-1)*3+2],d=C*C+c*c+g*g;d<u[i]&&(u[i]=d),A+=u[i]}let s=a()*A,o=r-1;for(let i=0;i<r;i++)if(s-=u[i],s<=0){o=i;break}t[l*3]=e[o*3],t[l*3+1]=e[o*3+1],t[l*3+2]=e[o*3+2]}return t}const x=150;async function H(e,r){const{width:n,height:a,data:t}=await K(e,r),B=n*a,u=new Int16Array(B).fill(-1),l=R(t,B),A=new Uint8Array(B);for(let h=0;h<B;h++)A[h]=t[h*4+3]>=x?255:0;r.removeBackground&&T(l,A,n,a),b(l,r.vividness??0);const s=new Int32Array(B);let o=0;for(let h=0;h<B;h++)A[h]!==0&&(s[o++]=h);if(o===0)return{width:n,height:a,cells:u,threads:[],counts:[],stitched:0};const i=new Float64Array(o*3);for(let h=0;h<o;h++){const y=s[h]*3;i[h*3]=l[y],i[h*3+1]=l[y+1],i[h*3+2]=l[y+2]}const{centroids:C,labels:c}=z(i,r.colorCount),g=C.length/3,d=Array.from({length:g},(h,y)=>[C[y*3],C[y*3+1],C[y*3+2]]),D=O(d,r.palette),E=new Array(g).fill(0);for(let h=0;h<o;h++)u[s[h]]=c[h],E[c[h]]++;return J({width:n,height:a,cells:u,threads:D,counts:E,stitched:o})}async function K(e,r){const n=await createImageBitmap(e),a=Math.max(1,Math.round(r.stitchWidth)),t=Math.max(1,Math.round(a*n.height/n.width)),u=new OffscreenCanvas(a,t).getContext("2d",{willReadFrequently:!0});if(!u)throw n.close(),new Error("canvas 2d context unavailable");return u.imageSmoothingEnabled=!0,u.imageSmoothingQuality="high",(r.flipH||r.flipV)&&(u.translate(r.flipH?a:0,r.flipV?t:0),u.scale(r.flipH?-1:1,r.flipV?-1:1)),u.drawImage(n,0,0,n.width,n.height,0,0,a,t),n.close(),{width:a,height:t,data:u.getImageData(0,0,a,t).data}}function _(e){return{width:e.width,height:e.height,cells:e.cells,threadNums:e.threads.map(r=>r.num),counts:e.counts,stitched:e.stitched}}function J(e){const r=e.threads.map((t,B)=>({i:B,key:$(t.rgb)})).sort((t,B)=>t.key[0]-B.key[0]||t.key[1]-B.key[1]||t.key[2]-B.key[2]).map(t=>t.i),n=new Int16Array(e.threads.length);r.forEach((t,B)=>{n[t]=B});const a=new Int16Array(e.cells.length);for(let t=0;t<e.cells.length;t++)a[t]=e.cells[t]<0?-1:n[e.cells[t]];return{...e,cells:a,threads:r.map(t=>e.threads[t]),counts:r.map(t=>e.counts[t])}}function $(e){const[r,n,a]=e.map(A=>A/255),t=Math.max(r,n,a),B=Math.min(r,n,a),u=t-B;let l=0;return u!==0&&(t===r?l=(n-a)/u%6:t===n?l=(a-r)/u+2:l=(r-n)/u+4,l/=6,l<0&&(l+=1)),[l,t===0?0:u/t,t]}self.onmessage=async e=>{const{id:r,photo:n,stitchWidth:a,colorCount:t,paletteNums:B,vividness:u,removeBackground:l,flipH:A,flipV:s}=e.data;try{const o=B?B.map(q).filter(c=>!!c):void 0,i=await H(n,{stitchWidth:a,colorCount:t,palette:o,vividness:u,removeBackground:l,flipH:A,flipV:s}),C=_(i);self.postMessage({id:r,ok:!0,pattern:C},[C.cells.buffer])}catch(o){self.postMessage({id:r,ok:!1,error:o instanceof Error?o.message:String(o)})}}})();
